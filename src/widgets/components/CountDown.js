...
class CountDown extends PureComponent {
  ...
  render () {
    return (
      <TouchableOpacity activeOpacity={0.5} disabled={this.state.disabled} onPress={this.onPress} style={[styles.vcode]}>
        {this.state.countdown >= 0 ?
          <Text style={styles.vcodeText}>
            {`${this.state.countdown}`}S
          </Text> :
          <Text style={[styles.vcodeText, this.state.disabled ? styles.vcodeDisabled : ""] }>
            {/* {I18n.t("login.Get")} */}
