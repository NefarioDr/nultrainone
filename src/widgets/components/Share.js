...
class SharePage extends React.Component {
  ...
  shareArticleSource = (params) => {
    shareService.saveShareArticleRecord(params).then(result => {
  ...
  shareActivitySource = (params) => {
    shareService.saveShareActivityRecord(params).then(result => {
      if (result.state === 'success') {
        //console.log("分享成功");
      } else {
        ToastUtil.showShort(result.message, true)
  ...
  handleShareToSession = async () => {
    ...
    WeChat.isWXAppInstalled().then((isInstalled) => {
      if (isInstalled) {
        ...
        WeChat.shareToSession(shareImage ? {
  ...
  handleShareToTimeline = async () => {
    ...
    WeChat.isWXAppInstalled().then((isInstalled) => {
      if (isInstalled) {
        ...
        WeChat.shareToTimeline(shareImage ? {
          title: this.props.shareOptions.title,
          description: this.props.shareOptions.message,
          type: 'imageFile',
          mediaTagName: 'image',
  ...
  snapshot = async (refname, toast = true) => {
    if (this.props.onSnapshot) {
      ...
      const res = refname ? await captureRef(ref, this.state.value) : await captureScreen(this.state.value)
      const uri = this.state.value.result === 'base64'
        ...
        <Modal onRequestClose={() => {
          ...
          <View style={styles.container}>
            <View style={styles.listWrap}>
              <TouchableOpacity
                onPress={() => this.handleShareToSession()} style={styles.shareParent}>
                <View style={styles.shareContent}>
                  <Image style={styles.shareIcon} source={{ uri: Images.SHARE_WEIXIN }}/>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => this.handleShareToTimeline()} style={styles.shareParent}>
                <View style={styles.shareContent}>
                  <Image style={styles.shareIcon} source={{ uri: Images.SHARE_PENGYOUQUAN }}/>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
                ...
                <View style={styles.shareContent}>
                  <Image style={styles.shareIcon} source={{ uri: Images.SHARE_FACEBOOK }}/>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
                ...
                <View style={styles.shareContent}>
                  <Image style={styles.shareIcon} source={{ uri: Images.SHARE_TWITTER }}/>
                </View>
              </TouchableOpacity>
            </View>
            <View style={styles.listWrap2}>
              <TouchableOpacity
                ...
                <View style={styles.shareContent}>
                  <Image style={styles.shareIcon} source={{ uri: Images.SNAPSHORT_ICON }}/>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
                ...
                <View style={styles.shareContent}>
                  <Image style={styles.shareIcon} source={{ uri: Images.CLIPBOARD_ICON }}/>
                </View>
              </TouchableOpacity>
              {/*<TouchableOpacity
                onPress={() => {
              ...
              <TouchableOpacity
                ...
                <View style={[styles.shareContent]}>
                  <Image style={styles.shareIcon} source={{ uri: Images.MORE_ICON }}/>
                </View>
              </TouchableOpacity>
            </View>
            <View style={styles.closeWrap}>
              ...
              >
                <View style={styles.shareContent}>
                  <Image style={styles.shareCloseIcon} source={{ uri: Images.SAHRE_CLOSE }}/>
                </View>
              </TouchableOpacity>
            </View>
          </View>
...
export default connect(mapStateToProps, null, null, { withRef: true })(SharePage)
